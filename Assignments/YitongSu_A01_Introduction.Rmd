...
> Answer: I took an introductory Statistics course, which also contained some hands-on experience with using R studio. I also went over some self-learning resources about data analytics online, such as Coursera, in an informal setting.

2. Are there any components of the course about which you feel confident?

> Answer: I am confident about basic coding with R and formatting in R studio.

3. Are there any components of the course about which you feel apprehensive?

> Answer: I might need to spend more time understanding quantitative data analysis and modeling.
...
> Answer: https://github.com/sytspg/EDE_Fall2025
