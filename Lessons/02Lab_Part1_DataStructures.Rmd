...
# Combines vector1 and vector4
c(vector1, vector4)

# Multiplies the two vectors element by element
vector1 * vector4

# Multiple each element in the vector by 10
vector1 * 10

# Convert the elements in the vector to character strings, in upperclass.
toupper(vector2) 

# Neglect the value of an expression (in this case, logical)
!vector3
...
#The average temperature is 81.6°F.
...
matrix2
#matrix2 has 5 rows and 4 columns, byrow means the matrix is filled by rows.
...
matrix1[4, 1] #Row4, Col1

matrix1[4,  ] #Row4

matrix1[ , 3] #Col3

matrix1[c(12, 14)] #choose the 12th and the 14th, by col

matrix1[c(12:14)] #choose between the 12th and 14th, by col

matrix1[2:4, 1:3] #choose row2-4 and col1-3
